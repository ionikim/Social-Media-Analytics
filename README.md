...
| Applied Stream More Algorithm                  | Applied the Stream-Moore community detection algorithm to HVG adjacency matrix. Algorithm failed to converge due to uniform node degree (~22) and negative modularity (Q ≈ -0.0001), identifying the algorithm as unsuitable for this graph                                                                 | Antonia   
